...
{
    public partial class AddPublicationBibsPublicationComponent : ComponentBase
    {
        ...
        {
            publicationbibspublication = new CyberTool.Models.PublicationBibs.PublicationBibsPublication(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(CyberTool.Models.PublicationBibs.PublicationBibsPublication args)
        {
            try
            {
                var publicationBibsCreatePublicationBibsPublicationResult = await PublicationBibs.CreatePublicationBibsPublication(publicationBibsPublication:publicationbibspublication);
                DialogService.Close(publicationbibspublication);
            }
            catch (System.Exception publicationBibsCreatePublicationBibsPublicationException)
            {
                NotificationService.Notify(NotificationSeverity.Error, $"Error", $"Unable to create new PublicationBibsPublication!");
            }
        }
