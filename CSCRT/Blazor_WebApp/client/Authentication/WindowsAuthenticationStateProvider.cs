...
namespace CyberTool.Authentication
{
    public class WindowsAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            var token = await jsRuntime.InvokeAsync<string>("sessionStorage.getItem", "CyberToolToken");
            ...
            if (string.IsNullOrWhiteSpace(token))
            {
                ...
                await jsRuntime.InvokeVoidAsync("sessionStorage.setItem", "CyberToolToken", token);
            }
